                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    ?>
                                    <?php
                                    echo  $form->errorSummary($adminLogin)
                                    ?>
                                        <fieldset>
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<?php
                                                            echo $form->textField($adminLogin,'username',array('placeholder'=>'Username','class'=>'form-control'))
                                                            ?>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<?php
                                                            echo $form->passwordField($adminLogin,'password', array('placeholder'=>'Password','class'=>'form-control'))
                                                            ?>
                                            ...
                                            <div class="clearfix">
                                                <label class="inline">
                                                    <?php
                                                    echo $form->checkBox($adminLogin ,'rememberMe')
