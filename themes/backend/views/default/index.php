        ...
        <div class="row">
                        ...
                        <div class="widget-main padding-4">
                            <div class="tab-content padding-8">
                                ...
                                <div id="comment-tab" class="tab-pane">
                                    <div style="position: relative;" class="comments ace-scroll"><div style="display: none;" class="scroll-track"><div class="scroll-bar"></div></div><div style="max-height: 300px;" class="scroll-content">
            ...
            <div class="col-sm-6">
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main no-padding">
                            <div class="dialogs ace-scroll"><div style="display: block; height: 300px;" class="scroll-track scroll-active"><div style="height: 233px; top: 0px;" class="scroll-bar"></div></div><div style="max-height: 300px;" class="scroll-content">
