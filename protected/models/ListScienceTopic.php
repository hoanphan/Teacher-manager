...
class ListScienceTopic extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, id_teacher, Classification', 'required'),
			array('id_teacher, Classification', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>200),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, id_teacher, Classification', 'safe', 'on'=>'search'),
		);
	}
